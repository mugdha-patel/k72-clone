...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="flex z-4 fixed top-0 w-full items-start justify-between ">
                <div className='lg:w-30 w-18 lg:p-5 p-3'>
                ...
                className=' cursor-pointer lg:h-16 h-10 bg-black relative lg:w-[16vw] w-36'>
